...
#text
cv.putText(img, "Hello World!", (100, 200), cv.FONT_HERSHEY_DUPLEX, 2.5, (255, 255, 0), 8) #putText(image, text to be written on image, position where we want to write it, font type and size, color in BGR format, thickness)
